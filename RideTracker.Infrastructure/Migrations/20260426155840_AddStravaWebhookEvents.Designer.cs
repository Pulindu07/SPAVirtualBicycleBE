...
namespace RideTracker.Infrastructure.Migrations
{
    ...
    [Migration("20260426155840_AddStravaWebhookEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RideTracker.Domain.Entities.Route", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RideTracker.Domain.Entities.StravaWebhookEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_strava_webhook_events_owner_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_strava_webhook_events_status");

                    b.HasIndex("ObjectType", "ObjectId", "AspectType", "EventTime")
                        .HasDatabaseName("ix_strava_webhook_events_dedup");

                    b.ToTable("strava_webhook_events", (string)null);
                });
            ...
            modelBuilder.Entity("RideTracker.Domain.Entities.Challenge", b =>
                {
                    ...
                    b.HasOne("RideTracker.Domain.Entities.Route", "Route")
                        .WithMany()
